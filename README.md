...
3. Se filtraron los eventos de autenticación fallida (Event ID 4625) y exitosa (Event ID 4624) del canal Security
4. Se identificaron 7 cuentas objetivo de un ataque de fuerza bruta, todas fallidas en una ventana de 12 milisegundos
...
El informe de incidente detallado (timeline completo, IOCs, análisis técnico, impacto y recomendaciones) está disponible acá: 👉 [informe-incidente.md](./informe-incidente.md)
...
- [Security Datasets (OTRF)](https://github.com/OTRF/Security-Datasets)
- [PurpleSharp (herramienta de simulación)](https://github.com/mvelazc0/PurpleSharp)
- [MITRE ATT&CK](https://attack.mitre.org/)

---

**Autor:** Max Vásquez ([@maxvasquezdev](https://github.com/maxvasquezdev))